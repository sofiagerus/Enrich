namespace Enrich.BLL.Constants
{
    public static class UserConstants
    {
        ...
        public const string UsernameInvalidFormat = "Only Latin letters, dots, and underscores are allowed";
        public const int UsernameMinLength = 3;
        public const int UsernameMaxLength = 16;
        public const string UsernameAllowedCharactersRegex = "^[a-zA-Z._]*$";
    }
}